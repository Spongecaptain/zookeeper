...
public interface Watcher {
     ...
     */
    /**
     * Event 为 Watcher 接口的内部接口用于描述一个 Event 的状态，一个 Event 的状态包括 3 个方面：
     * - Event 的事件类型
     * - Watcher 的类型(关于子节点、当前节点数据还是任意之一)
     * - 此时 ZooKeeper 客户端的状态(主要是指连接状态)
     */
    @InterfaceAudience.Public
    interface Event {
         ...
         */
        //此 Event 接口的 KeeperState 枚举类型用于指定客户端特定的状态
        @InterfaceAudience.Public
        enum KeeperState {
